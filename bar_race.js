...
const title = `Top 10 Public Companies from 2000-2019 (${yearStart}-${yearEnd})`;
const subTitle = "(Market Cap)";
...
d3.csv("SampleData/category-brands.csv")
.then(function( data ) {
